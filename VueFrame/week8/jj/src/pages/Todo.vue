<template>
  <div class="container">
    ...
    <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage"
      :page-sizes="[10, 20, 30, 40]" :page-size="10" layout="total, sizes, prev, pager, next, jumper" :total="taskList.length">
    </el-pagination>
...
export default {
  ...
  methods: {
    ...
    handleSizeChange(val) {
      this.$store.dispatch("todo/updateTodoListAction", { limit: val });
    },
    //
    handleCurrentChange(val) {
      this.$store.dispatch("todo/updateTodoListAction", { page: val });
    },
    // 点击提交按钮进行表单校验
    submitForm(formName) {
